-- =========================================
-- DATABASE BOOKCHILL - FILE GỘP
-- Gộp từ: Data.sql + DB_Seed_MotBookstore.sql + DB_Upgrade.sql
-- Chạy 1 lần duy nhất. Reset DB sạch hoàn toàn.
-- =========================================
...
-- =========================================
-- DATA: SAN PHAM - 28 sach (goc + motbookstore)
-- =========================================
...
-- Category 1: Sach giao khoa (4 sach)
